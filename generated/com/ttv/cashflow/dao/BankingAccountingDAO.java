...
public interface BankingAccountingDAO extends JpaDao<BankingAccounting> {
	 ...
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByFilePathContaining(String filePath_1) throws DataAccessException;

	/**
	 * JPQL Query - findBankingAccountingByFilePathContaining
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByFilePathContaining(String filePath_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByCorrespondingAccName(String correspondingAccName_1) throws DataAccessException;

	/**
	 * JPQL Query - findBankingAccountingByCorrespondingAccName
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByCorrespondingAccName(String correspondingAccName_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByVoucherNoContaining(String voucherNo_1) throws DataAccessException;

	/**
	 * JPQL Query - findBankingAccountingByVoucherNoContaining
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByVoucherNoContaining(String voucherNo_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByDescriptionContaining(String description_1) throws DataAccessException;

	/**
	 * JPQL Query - findBankingAccountingByDescriptionContaining
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByDescriptionContaining(String description_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByValidCodeContaining(String validCode_1) throws DataAccessException;

	/**
	 * JPQL Query - findBankingAccountingByValidCodeContaining
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByValidCodeContaining(String validCode_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByCorrespondingAccNo(String correspondingAccNo_1) throws DataAccessException;

	/**
	 * JPQL Query - findBankingAccountingByCorrespondingAccNo
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByCorrespondingAccNo(String correspondingAccNo_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByVendorName(String vendorName_1) throws DataAccessException;

	/**
	 * JPQL Query - findBankingAccountingByVendorName
	 *
	 */
	public Set<BankingAccounting> findBankingAccountingByVendorName(String vendorName_1, int startResult, int maxRows) throws DataAccessException;
