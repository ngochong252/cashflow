...
public class ApprovalDAOTest {
	 ...
	 *
	 */
	private ApprovalDAO dataStore;

	/**
	 * Instantiates a new ApprovalDAOTest.
	 *
	 */
	public ApprovalDAOTest() {
	}

	/**
	* Method to test Approval domain object.
	*
	*/
	@Rollback(false)
	@Test
	...
	*/
	@Autowired
	public void setDataStore(ApprovalDAO dataStore) {
