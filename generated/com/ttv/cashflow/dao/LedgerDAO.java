...
public interface LedgerDAO extends JpaDao<Ledger> {
	 ...
	 *
	 */
	public Set<Ledger> findLedgerByDescription(String description_1) throws DataAccessException;

	/**
	 * JPQL Query - findLedgerByDescription
	 *
	 */
	public Set<Ledger> findLedgerByDescription(String description_1, int startResult, int maxRows) throws DataAccessException;
