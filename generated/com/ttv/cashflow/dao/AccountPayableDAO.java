...
public interface AccountPayableDAO extends JpaDao<AccountPayable> {
	 ...
	 *
	 */
	public Set<AccountPayable> findAccountPayableByClass_(String class__1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByClass_
	 *
	 */
	public Set<AccountPayable> findAccountPayableByClass_(String class__1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<AccountPayable> findAccountPayableByClassCode(String classCode_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByClassCode
	 *
	 */
	public Set<AccountPayable> findAccountPayableByClassCode(String classCode_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<AccountPayable> findAccountPayableByCorrespondingAccNo(String correspondingAccNo_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByCorrespondingAccNo
	 *
	 */
	public Set<AccountPayable> findAccountPayableByCorrespondingAccNo(String correspondingAccNo_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<AccountPayable> findAccountPayableByDescriptionContaining(String description_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByDescriptionContaining
	 *
	 */
	public Set<AccountPayable> findAccountPayableByDescriptionContaining(String description_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<AccountPayable> findAccountPayableByInvoiceNo(String invoiceNo_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByInvoiceNo
	 *
	 */
	public Set<AccountPayable> findAccountPayableByInvoiceNo(String invoiceNo_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<AccountPayable> findAccountPayableByVendorName(String vendorName_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByVendorName
	 *
	 */
	public Set<AccountPayable> findAccountPayableByVendorName(String vendorName_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<AccountPayable> findAccountPayableByValidCode(String validCode_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByValidCode
	 *
	 */
	public Set<AccountPayable> findAccountPayableByValidCode(String validCode_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByPvNo
	 *
	 */
	public Set<AccountPayable> findAccountPayableByPvNo(String pvNo_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByPvNo
	 *
	 */
	public Set<AccountPayable> findAccountPayableByPvNo(String pvNo_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByMonth
	 *
	 */
	public Set<AccountPayable> findAccountPayableByMonth(String month_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByMonth
	 *
	 */
	public Set<AccountPayable> findAccountPayableByMonth(String month_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<AccountPayable> findAccountPayableByVatTypeContaining(String vatType_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByVatTypeContaining
	 *
	 */
	public Set<AccountPayable> findAccountPayableByVatTypeContaining(String vatType_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<AccountPayable> findAccountPayableByCorrespondingAccTypeContaining(String correspondingAccType_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByCorrespondingAccTypeContaining
	 *
	 */
	public Set<AccountPayable> findAccountPayableByCorrespondingAccTypeContaining(String correspondingAccType_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByInpt
	 *
	 */
	public Set<AccountPayable> findAccountPayableByInpt(String inpt_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByInpt
	 *
	 */
	public Set<AccountPayable> findAccountPayableByInpt(String inpt_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<AccountPayable> findAccountPayableBySettlementVoucherNo(String settlementVoucherNo_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableBySettlementVoucherNo
	 *
	 */
	public Set<AccountPayable> findAccountPayableBySettlementVoucherNo(String settlementVoucherNo_1, int startResult, int maxRows) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByPrimaryKey
	 *
	 */
	public AccountPayable findAccountPayableByPrimaryKey(Integer id_1) throws DataAccessException;

	/**
	 * JPQL Query - findAccountPayableByPrimaryKey
	 *
	 */
	public AccountPayable findAccountPayableByPrimaryKey(Integer id_1, int startResult, int maxRows) throws DataAccessException;
