...
public interface ErrorDetailsDAO extends JpaDao<ErrorDetails> {
	 ...
	 *
	 */
	public Set<ErrorDetails> findErrorDetailsByDescription(String description_1) throws DataAccessException;

	/**
	 * JPQL Query - findErrorDetailsByDescription
	 *
	 */
	public Set<ErrorDetails> findErrorDetailsByDescription(String description_1, int startResult, int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public ErrorDetails findErrorDetailsById(Integer id_1) throws DataAccessException;

	/**
	 * JPQL Query - findErrorDetailsById
	 *
	 */
	public ErrorDetails findErrorDetailsById(Integer id_1, int startResult, int maxRows) throws DataAccessException;
