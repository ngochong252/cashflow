...
<html>
<head>
<title>Edit <fmt:message key="approval.title"/> <fmt:message key="comapny.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveApprovalComapny" method="POST" modelAttribute="comapny">
