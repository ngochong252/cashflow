...
<html>
<head>
<title>View <fmt:message key="comapny.title"/> <fmt:message key="approval.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			<h1><fmt:message key="navigation.view"/> <fmt:message key="approval.title"/></h1>
			...
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/deleteComapnyApprovals?comapny_companyId=${comapny_companyId}&related_approvals_id=${approval.id}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
	</div></div></div></div>
