...
<html>
<head>
<title>Edit <fmt:message key="comapny.title"/> <fmt:message key="approval.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveComapnyApprovals" method="POST" modelAttribute="approval">
