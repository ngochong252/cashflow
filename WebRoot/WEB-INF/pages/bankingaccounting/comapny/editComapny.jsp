...
<html>
<head>
<title>Edit <fmt:message key="bankingaccounting.title"/> <fmt:message key="comapny.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveBankingAccountingComapny" method="POST" modelAttribute="comapny">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="bankingaccounting_id" value="${bankingaccounting_id}" >
