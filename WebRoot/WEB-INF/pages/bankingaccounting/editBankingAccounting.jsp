...
<html>
<head>
<title>Edit <fmt:message key="bankingaccounting.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveBankingAccounting" method="POST" modelAttribute="bankingaccounting">
