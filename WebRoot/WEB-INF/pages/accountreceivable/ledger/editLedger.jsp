...
<html>
<head>
<title>Edit <fmt:message key="accountreceivable.title"/> <fmt:message key="ledger.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveAccountReceivableLedger" method="POST" modelAttribute="ledger">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="accountreceivable_id" value="${accountreceivable_id}" >
