	...
	<div id="brc"><div id="tb"><div id="tlc"><div id="trc">
		<div id="content">
			...
			<h1><fmt:message key="ledger.title"/></h1>
						...
						<c:if test='${accountpayable.ledger != null}'>
			<table cellpadding="0" cellspacing="0" id="viewTable">
				<tbody>
					<tr>
						<td  class="label">
					...
					<tr>
						...
						<td>
							<fmt:formatDate dateStyle="short" type="both" value="${accountpayable.ledger.issuedDate.time}"/>
						&nbsp;
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							${accountpayable.ledger.validCode}
						&nbsp;
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							${accountpayable.ledger.filePath}
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							<fmt:formatDate dateStyle="short" type="both" value="${accountpayable.ledger.createdDate.time}"/>
						&nbsp;
						</td>
					</tr>
					<tr>
						...
						<td>
							<fmt:formatDate dateStyle="short" type="both" value="${accountpayable.ledger.modifiedDate.time}"/>
						&nbsp;
						</td>
					</tr>
				</tbody>
			</table>
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/editAccountPayableLedger?accountpayable_id=${accountpayable.id}&ledger_id=${accountpayable.ledger.id}&"><span><img src="images/icons/edit.gif" /><fmt:message key="navigation.edit"/></span></a></div>
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/confirmDeleteAccountPayableLedger?accountpayable_id=${accountpayable.id}&related_ledger_id=${accountpayable.ledger.id}&"><span><img src="images/icons/delete.gif" /><fmt:message key="navigation.delete"/></span></a></div>
						</c:if>
						<c:if test='${accountpayable.ledger == null}'>
			<div class="navitem"><a class="button" href="${pageContext.request.contextPath}/newAccountPayableLedger?accountpayable_id=${accountpayable.id}&"><span><img src="images/icons/new.gif" /><fmt:message key="navigation.new"/> <fmt:message key="ledger.title"/></span></a></div>
						</c:if>
			<div class="clear">&nbsp;</div>
		</div>
	</div></div></div></div>
