...
<html>
<head>
<title>Edit <fmt:message key="accountpayable.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveAccountPayable" method="POST" modelAttribute="accountpayable">
