...
<html>
<head>
<title>Edit <fmt:message key="errordetails.title"/> <fmt:message key="processcase.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveErrorDetailsProcessCases" method="POST" modelAttribute="processcase">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="errordetails_id" value="${errordetails_id}" >
