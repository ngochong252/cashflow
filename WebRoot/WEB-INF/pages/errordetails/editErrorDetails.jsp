...
<html>
<head>
<title>Edit <fmt:message key="errordetails.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveErrorDetails" method="POST" modelAttribute="errordetails">
