...
<html>
<head>
<title>Edit <fmt:message key="ledger.title"/> <fmt:message key="accountreceivable.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveLedgerAccountReceivables" method="POST" modelAttribute="accountreceivable">
